...
class LenderActivityProvider extends ChangeNotifier {
  ...
  Future<void> fetchData() async {
    ...
    final url = Uri.parse('http://127.0.0.1:8000/lender/activity/');
...
class ActivityPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final activityProvider = Provider.of<LenderActivityProvider>(context);
    ...
    return MaterialApp(
        ...
        home: DefaultTabController(
          ...
          child: Scaffold(
            ...
            body: FutureBuilder(
                future:
                    Provider.of<LenderActivityProvider>(context, listen: false)
                        .fetchData(),
